...
class __TwigTemplate_e10e5381d1fea85373f29f6a7e108dc6bb50348c52a3b5377f968c9a4c127838 extends Twig_Template
{
    ...
    {
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("title_dashboard", [], "SonataAdminBundle"), "html", null, true);
    }
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["block"]) {
            // line 20
            echo "        ";
            if (((twig_length_filter($this->env, $this->getAttribute($context["block"], "roles", [])) == 0) || $this->env->getExtension('Sonata\AdminBundle\Twig\Extension\SonataAdminExtension')->isGrantedAffirmative($this->getAttribute($context["block"], "roles", [])))) {
                // line 21
                echo "            ";
    ...
    ";
        // line 53
        echo call_user_func_array($this->env->getFunction('sonata_block_render_event')->getCallable(), ["sonata.admin.dashboard.top", ["admin_pool" => $this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : null), "adminPool", [])]]);
        echo "
        ...
        if ((isset($context["has_top"]) ? $context["has_top"] : null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["block"]) {
                ...
                if (((twig_length_filter($this->env, $this->getAttribute($context["block"], "roles", [])) == 0) || $this->env->getExtension('Sonata\AdminBundle\Twig\Extension\SonataAdminExtension')->isGrantedAffirmative($this->getAttribute($context["block"], "roles", [])))) {
                    // line 59
                    echo "                    <div class=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute($context["block"], "class", []), "html", null, true);
                    echo "\">
                        ";
                    // line 60
                    echo call_user_func_array($this->env->getFunction('sonata_block_render')->getCallable(), [["type" => $this->getAttribute($context["block"], "type", []), "settings" => $this->getAttribute($context["block"], "settings", [])]]);
                    echo "
                    </div>
                ";
                }
    ...
    ";
        // line 128
        echo call_user_func_array($this->env->getFunction('sonata_block_render_event')->getCallable(), ["sonata.admin.dashboard.bottom", ["admin_pool" => $this->getAttribute((isset($context["sonata_admin"]) ? $context["sonata_admin"] : null), "adminPool", [])]]);
        echo "
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:Core:dashboard.html.twig", "/home/www/sfproject/sf3GrcEternity/releases/20190225100256/vendor/sonata-project/admin-bundle/src/Resources/views/Core/dashboard.html.twig");
    }
}
